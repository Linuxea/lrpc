...
import com.linuxea.lrpc.client.net.socket.SocketPrototypeGenerate;
...
public class RpcClientTest {
    ...
    public void testClient() throws InterruptedException {
        ...
        NetClient shortConnectNetClient = new ShortConnectNetClient(new LengthFieldCodec(), new SocketPool(10));
